...
EXPORT_SYMBOL_GPL(bmg160_init);
EXPORT_SYMBOL_GPL(bmg160_get_dataXYZ);
EXPORT_SYMBOL_GPL(bmg160_get_range_reg);
EXPORT_SYMBOL_GPL(bmg160_set_range_reg);
EXPORT_SYMBOL_GPL(bmg160_set_bw);
EXPORT_SYMBOL_GPL(bmg160_enable_fast_offset);
EXPORT_SYMBOL_GPL(bmg160_set_fast_offset_en_ch);
EXPORT_SYMBOL_GPL(bmg160_set_slow_offset_en_ch);
EXPORT_SYMBOL_GPL(bmg160_set_slow_offset_dur);
EXPORT_SYMBOL_GPL(bmg160_set_slow_offset_th);
EXPORT_SYMBOL_GPL(bmg160_selftest);
EXPORT_SYMBOL_GPL(bmg160_get_sleepdur);
EXPORT_SYMBOL_GPL(bmg160_set_sleepdur);
EXPORT_SYMBOL_GPL(bmg160_get_autosleepdur);
EXPORT_SYMBOL_GPL(bmg160_set_autosleepdur);
