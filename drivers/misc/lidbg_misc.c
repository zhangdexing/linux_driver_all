...
static void iptable_1_sim2_normal(void)
{
	...
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|app|03|api|02|ai|08|flyaudio|02|cn\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|app|03|oss|02|ai|08|flyaudio|02|cn\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|08|flyaudio|02|cn\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|04|mqtt|08|aliyuncs|02|cn\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|02|mp|06|weixin|02|qq|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|api|06|weixin|02|qq|03|com\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|04|amap|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|01|a|08|autonavi|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|xiaomor|03|com\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|08|aispeech|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|08|amap-api|11|cn-hangzhou|07|oss-pub|10|aliyun-inc|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|05|bugly|02|qq|03|com\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|hivoice|02|cn\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|06|txzing|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|06|boscdn|05|baidu|03|com\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|10|vectormap0|05|bdimg|03|com\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|offmap1|05|baidu|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|04|bdns|05|baidu|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|api|08|codriver|05|baidu|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|09|privatefm|05|baidu|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|automap|03|cdn|06|bcebos|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|05|baidu|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|ss0|08|bdstatic|03|com\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|08|passport|05|bdimg|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -d 14.215.177.69 -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -p udp --dport 53 -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST  -m string  --string boscdn.baidu.com --algo bm -j REJECT	");
...
static void iptable_6_sim2_normal_kuwo(void)
{
	...
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|hivoice|02|cn\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|06|txzing|03|com\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|04|kuwo\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|06|boscdn|05|baidu|03|com\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|10|vectormap0|05|bdimg|03|com\" --algo bm -j REJECT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|07|offmap1|05|baidu|03|com\" --algo bm -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|04|bdns|05|baidu|03|com\" --algo bm -j REJECT	");
...
static void iptable_2_sim2_invailed(void)
{
	...
	lidbg_shell_cmd("	iptables -I FORWARD -j WEBWHITELIST 	");
	lidbg_shell_cmd("	iptables -I OUTPUT -j WEBWHITELIST	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|03|iot|03|api|02|ai|08|flyaudio|02|cn\" --algo bm -j ACCEPT ");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--hex-string \"|06|wechat|03|oss|02|ai|08|flyaudio|02|cn\" --algo bm -j ACCEPT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -p udp --dport 53 -j REJECT	");
	lidbg_shell_cmd("	iptables -A WEBWHITELIST -m string	--string Host: --algo bm -j MARK --set-mark 1	");
