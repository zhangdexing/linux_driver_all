...
static ssize_t cyttsp4_panel_scan_store(struct device *dev,
...
static ssize_t cyttsp4_get_idac_store(struct device *dev,
		struct cyttsp4_attribute *attr, const char *buf, size_t size)
{
	struct cyttsp4_device_access_data *dad
		= cyttsp4_get_device_access_data(dev);
...
static ssize_t cyttsp4_opens_store(struct device *dev,
		struct cyttsp4_attribute *attr, const char *buf, size_t size)
{
	struct cyttsp4_device_access_data *dad
		= cyttsp4_get_device_access_data(dev);
...
static ssize_t cyttsp4_baseline_store(struct device *dev,
		struct cyttsp4_attribute *attr, const char *buf, size_t size)
{
	struct cyttsp4_device_access_data *dad
		= cyttsp4_get_device_access_data(dev);
