...
uvc_xu_control_info sonix_xu_sys_ctrls[]={

	{
		UVC_GUID_SONIX_SYS_HW_CTRL,
		XU_SONIX_SYS_ASIC_RW,
		0,
		4,
...
uvc_xu_control_info sonix_xu_usr_ctrls[] =
{
    {
      UVC_GUID_SONIX_USR_HW_CTRL,
      XU_SONIX_USR_FRAME_INFO,
      0,
      11,
      UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX |
                  UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
    ...
    {
      UVC_GUID_SONIX_USR_HW_CTRL,
      XU_SONIX_USR_MULTI_STREAM_CTRL,
      6,
      11,
      UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },	
...
uvc_xu_control_mapping_2_6 sonix_xu_sys_mappings[] = 
{
	{
		 V4L2_CID_ASIC_RW_SONIX,
		 "SONiX: Asic Read",
		 UVC_GUID_SONIX_SYS_HW_CTRL,
		 XU_SONIX_SYS_ASIC_RW,
		 4,
	...
	{
		 V4L2_CID_MOTION_DETECTION_SONIX,
		 "SONiX: Motion Detection",
		 UVC_GUID_SONIX_SYS_HW_CTRL,
		 XU_SONIX_SYS_MOTION_DETECTION,
		 11,
		 0,
...
static struct uvc_xu_control_mapping_2_6 sonix_xu_usr_mappings[] =
{
    ...
    {
       V4L2_CID_MULTI_STREAM_CTRL_SONIX,
       "SONiX: Multi Stram Control ",
       UVC_GUID_SONIX_USR_HW_CTRL,
       XU_SONIX_USR_MULTI_STREAM_CTRL,
       11,
       0,
    ...
    {
       V4L2_CID_DYNAMIC_FPS_CTRL_SONIX,
       "SONiX: Dynamic fps Control ",
       UVC_GUID_SONIX_USR_HW_CTRL,
       XU_SONIX_USR_DYNAMIC_FPS_CTRL,
       11,
       0,
...
int XU_H264_Get_GOP(int fd, int *GOP)
{
