...
int GetCapability(int fd, struct CapabiltyBinaryData *pCapData)
{
    ...
    pBuffer = (unsigned char*)malloc(4 * sizeof(unsigned char));
    ...
    // get CapAddr, CapSize
    pBuffer = (unsigned char*)malloc(25 * sizeof(unsigned char));   // 1 + 2 * (10 + 1) + 2
    ...
    //get capability
    pCapData->pbuf= (unsigned char*)malloc(CapSize * sizeof(unsigned char)); 
