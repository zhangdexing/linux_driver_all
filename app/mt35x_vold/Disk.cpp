        ...
        if (!strcmp(token, "DISK")) {
            ...
            if (table == Table::kMbr) {
                ...
                case 0x0e: // W95 FAT16 (LBA)
                    ...
                    break;
		case 0x72: // add by barton zhang to mount Signal Partition of USB or SD Card With fstype flags : 72 65 79 0D
		case 0x4F: // add by bing han to mount Signal Partition of USB or SD Card With fstype flags : 4F 73 2b 61
		    partDevice = partDevice = makedev(major(mDevice), minor(mDevice));
		    createPublicVolume(partDevice);
		    break;
                }
